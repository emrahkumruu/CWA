 ...
 *  @version 1.0.0 
 *  @build Thu Feb 01 2018 12:15:56 GMT+0300 (+03) 
 */
"use strict";angular.module("cwa",["ngRoute","cwa.cities","cwa.citySingleView"]).config(["$locationProvider","$routeProvider",function(t,e){t.hashPrefix("!"),e.otherwise({redirectTo:"/cities"})}]).factory("Services",function(t){return{getJson:function(){return t.get("data/data.json")}}}),angular.module("cwa.cities",["ngRoute"]).config(["$routeProvider",function(t){t.when("/cities",{templateUrl:"templates/cities.html",controller:"citiesCtrl"})}]).controller("citiesCtrl",function(t,e){t.title="Welcome to Cities Weather App",e.getJson().then(function(e){t.Cities=angular.fromJson(e.data)})}),angular.module("cwa.citySingleView",["ngRoute"]).config(["$routeProvider",function(t){t.when("/city/:ID",{templateUrl:"templates/city-single.html",controller:"citySingleViewCtrl"})}]).controller("citySingleViewCtrl",function(t,e,i){var n=parseInt(e.ID);i.getJson().then(function(e){var i=angular.fromJson(e.data);t.city=i.filter(function(t){return t.id===n})})});